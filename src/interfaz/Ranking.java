...
public class Ranking extends javax.swing.JDialog {
    ...
    public Ranking(java.awt.Frame parent, boolean modal, Sistema sis) {
        super(parent, modal);
        initComponents();
        sistema = sis;
        this.setResizable(false);
        this.setLocationRelativeTo(null);
        ArrayList<Jugador> lista = sistema.ranking();        
        try {
            DefaultListModel modelo = new DefaultListModel();
            for (Jugador jugador : lista) {
                modelo.addElement(jugador.mostrarPartidas());
            }
            lsRanking.setModel(modelo);
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        lsRanking = new javax.swing.JList<>();
        ...
        jScrollPane1.setViewportView(lsRanking);
    ...
    private javax.swing.JList<String> lsRanking;
